package com.multipolar.bootcamp.loggingProduct.service;
...
import com.multipolar.bootcamp.loggingProduct.repository.AccessLogRepository;
...
public class KafkaConsumerService {
    ...
    // Listen to the "access-logs" topic from Kafka
    @KafkaListener(topics = "access_logs_product")
